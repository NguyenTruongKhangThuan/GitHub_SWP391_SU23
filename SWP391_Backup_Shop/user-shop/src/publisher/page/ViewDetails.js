            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex justify-between">
                ...
                <div className="flex gap-x-[80px]">
                  <Link to={`/shop/publisher/product/update/${product.gamePackId}`} className="flex justify-center items-center rounded-md bg-yellow-400 py-2 px-4 font-bold text-[14px]">
                    Update Product
                  </Link>
                  <Link to={"/shop/publisher"} className="flex justify-center items-center rounded-md mr-[120px]  bg-red-500 py-2 px-4 font-bold text-[14px]">
                      Return
                  </Link>
                </div>
              </div>
