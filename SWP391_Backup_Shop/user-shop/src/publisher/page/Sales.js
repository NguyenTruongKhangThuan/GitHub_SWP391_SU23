        ...
        <section className="container mx-auto ">
          <div className="flex gap-x-20">
            <div className="flex flex-col">
              ...
              <div className=" w-[1000px] h-[600px] mt-7">
            ...
            <div className="w-[300px] h-[680px]">
              <div
                className=" w-[300px] h-[720px] p-10 rounded-md flex flex-col justify-center items-center"
              >
                <h2 className="mb-8 text-[22px] font-bold text-white">Most Sold Products</h2>
