          ...
          <table className="mt-[10px]">
            ...
            <tbody className="bg-gray-200">
              {gameTags.map((gameTag, index) => (
                ...
                >
                  <td className={`${gameTags[gameTags.length - 1].gameTagId === gameTag.gameTagId? 'border-b-[2px]': ''} border-l-[2px] border-gray-500 pr-5 p-4`}>
                    <p className="p-2">{gameTag.gameTagId}</p>
                  </td>
                  <td className={`${gameTags[gameTags.length - 1].gameTagId === gameTag.gameTagId? 'border-b-[2px]': ''} border-gray-500 pr-5 p-4`}>
                    <p className="p-2">{gameTag.gameTagName}</p>
                  </td>
                  <td className={`${gameTags[gameTags.length - 1].gameTagId === gameTag.gameTagId? 'border-b-[2px]': ''} border-r-[2px] border-gray-500 pr-5 p-4`}>
