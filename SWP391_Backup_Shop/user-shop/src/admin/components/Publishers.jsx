...
const Owner = () => {
  ...
  const refreshPublishersList = async () => {
    ...
    const addFormSubmission = (e) => {
        ...
        let publisherPhoneNumber = document.getElementById('ownerPhoneNumber').value
                ...
                <tbody>
                    {publishers.map((publisher, index) => (
                        <tr className={`${index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-300'} text-[16px]`}>
                            ...
                            <td className='border-[2px] border-gray-500 pr-5 pl-2'>{publisher.password}</td>
                            ...
                            <td className='border-[2px] border-gray-500 pr-5 pl-2'> <Dropdown /> </td>
                        </tr>
                    ))}
                </tbody>
            </table>
