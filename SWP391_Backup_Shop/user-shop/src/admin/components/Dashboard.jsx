...
const Dashboard = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <div>
      ...
      <div className='flex flex-wrap justify-center mt-[30px] duration-300' style={{ gap: `0 ${gapX}px` }}>
        <div className='flex flex-col gap-y-1'>
          <div className='flex flex-row justify-center duration-300' style={{ gap: `0 ${gapX}px` }}>
          ...
          <div className='bg-white bg-opacity-10 w-[960px] h-[480px] p-10 rounded-md flex justify-center items-center mb-10' 
            style={{
              backdropFilter: 'blur(10px)',
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow: '0 0 10px rgba(0, 0, 0, 0.2)'
        ...
        <div className='bg-white bg-opacity-10 w-[300px] h-[720px] p-10 rounded-md flex flex-col justify-center items-center'
            style={{
              backdropFilter: 'blur(10px)',
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow: '0 0 10px rgba(0, 0, 0, 0.2)'
        ...
        >
          ...
          <div className='flex flex-col gap-y-8'>
            <HighlightedItems header={"Test Header"} content={"Test Content"} imgSrc={Highlight_1}/>
            <HighlightedItems header={"Test Header"} content={"Test Content"} imgSrc={Highlight_2}/>
            <HighlightedItems header={"Test Header"} content={"Test Content"} imgSrc={Highlight_3}/>
          </div>
        </div>
      </div>
    </div>
