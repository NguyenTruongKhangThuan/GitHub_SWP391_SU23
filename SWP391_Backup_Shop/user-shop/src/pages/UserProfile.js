                    ...
                    <section className='container mx-auto'>
                        ...
                        <form className='w-fit container mt-2'>
                            <div className='grid grid-cols-2 gap-x-[200px]'>
                                <section>
                                    <h2 className='my-2 text-xl font-bold'>Account Information</h2>
                        ...
                        <div className='flex justify-end gap-x-4 mt-8'>
                            <Link to={'/shop'}><button className='text-[16px] font-bold bg-red-500 px-6 py-3 rounded-md'>Return to Shop</button></Link>
                            {!isEditable ? (
                                <button
