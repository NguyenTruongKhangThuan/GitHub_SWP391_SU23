...
import { loginAPI, authenticationAPI } from '../api/userAPI';
                ...
                <div className="w-[460px] p-8 h-fit  bg-[#ffffffc2] rounded-lg">
                    <form className="h-fit flex flex-col px-[20px] gap-[10px]">
                        <header className="w-full text-center py-[20px] font-bold">
                            ...
                            <h4 className='text-[16px] font-medium'>Welcome to the shop, please login to continue</h4>
                        </header>
                        ...
                        <div className="flex flex-col items-center my-5 justify-center ">
                            ...
                            <div className='text-center mb-7 flex items-center justify-center gap-x-1'>
                                    ...
                                    <button className='text-blue-600' onClick={toggleForms}>Sign Up Now</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div className="h-fit flex flex-col justify-center items-center">
                        <form className="w-[500px] bg-[#ffffffc2] p-4 login rounded-lg shadow-md ">
                            <header className="w-full text-center py-[20px] font-bold">
                                ...
                                <h4 className='text-[16px] font-medium'>First time around? Come here and sign up!</h4>
                            </header>

                            <div className="flex flex-col">
                                <div className="flex flex-col py-2 mx-8">
                                    <label className="font-bold ml-1 mb-1">Username</label>
                                    <input type="text" id="sp-username" placeholder="Enter your Username" required className="border-b-2 border-solid p-2 "></input>
                                </div>
                                <div className="flex flex-col py-2 mx-8">
                                    <label className="font-bold ml-1 mb-1">Email</label>
                                    <input type="email" id="sp-email" placeholder="Enter your Email" required className="border-b-2 border-solid p-2 "></input>
                                </div>
                                <div className="flex flex-col py-2 mx-8">
                                    <label className="font-bold ml-1 mb-1">Password</label>
                                    <input type="password" id="sp-password" placeholder="Enter your Password" required className="border-b-2 border-solid p-2 "></input>
                                </div>
                                <div className="flex flex-col py-2 mx-8">
                                    <label className="font-bold ml-1 mb-1">Confirm Password</label>
                                    <input type="password" id="sp-password" placeholder="Enter your Password" required className="border-b-2 border-solid p-2 "></input>
                                </div>
                            </div>
                            <div className="flex items-center justify-center">
                                <button className=" border w-1/3 rounded-full font-bold mx-8 my-5 text-white py-2 bg-[#0A4D68] hover:bg-[#05BFDB]">
                                    Sign Up
                                </button>
                            </div>
                            <div className='text-center mb-7 flex items-center justify-center gap-x-1'>
                                <p>Already have an account?</p>
                                <button className='text-blue-600' onClick={toggleForms}>Login Now</button>
                            </div>
                        </form>
                    </div>
                </div>
